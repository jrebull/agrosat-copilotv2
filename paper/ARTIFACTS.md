...
|---|---|---|---|---|---|---|
| Miembros y protocolo: manifiesto del arnés OOF (fold 5, 18 clases, code_version) | `ml/eval/oof/manifest.json` | `97006bde7023bc514ddfd5b301e5b0e6` | 3758 | `373acb7` | SELLADO | Declara ahora `tsvit-pheno-fullm`, que faltaba, y para cada modelo temporal el `n_timesteps` que uso el dataset y el que espera el checkpoint: sin ese campo, un volcado con la T equivocada es indistinguible de uno correcto. |
