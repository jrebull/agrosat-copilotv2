...
**Sellado el**: 2026-09-04 · **Commit de sellado**: `15eb91c`
...
| Catalogo verificado de referencias del manuscrito NUEVO | `paper/micai2027/refs-candidates.bib` | `080602404bac5be8476fd777e863584d` | 23868 | pendiente | SELLADO | 57 entradas: las 44 de la matriz verificada mas Ha 1997, Mortier 2021 y Chzhen 2021, que US-141 exige y no estaban. **Fila INDEPENDIENTE de la del bib historico**: `paper/micai/refs.bib` sigue inmutable y ligado al PDF retirado. Se llama «candidates» porque sin manuscrito nuevo no hay citas nuevas; el `refs.bib` final se generara solo con las claves citadas, y las 26 citas del manuscrito retirado NO se atribuyen a este contexto. Autores sin truncar, identificador localizable en las 57. |
