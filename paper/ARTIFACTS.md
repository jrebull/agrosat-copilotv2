...
| Manuscrito nuevo: figura del soporte por clase, ingles | `reports/micai2027/figuras/soporte-en.svg` | `e3a993c5790cbf50ad811c5da901c8cc` | 68277 | `a62b504` | SELLADO | La misma figura con los rotulos en ingles, que es la lengua del envio. Mismos insumos, mismo contrato fisico, misma reproducibilidad. El `.pdf` de cada una es la misma figura en otro formato y no lleva fila propia: el ledger sella un representante por figura. |
