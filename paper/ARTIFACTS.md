...
| Fase 6: figura del soporte por clase de los dos bancos | `reports/paper_micai/figuras/soporte.svg` | `1c5fc41811a3bf307a82f36931f99d70` | 70411 | `5cb0831` | SELLADO | Escala logaritmica; la cola del segundo banco es degenerada, con dos y siete parcelas. **Regenerada**: rotulaba el banco como PASTIS-R y el articulo usa el optico. Sus insumos siguen SELLADO, asi que la figura sigue siendo citable. |
