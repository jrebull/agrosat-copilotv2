...
| Fase 6: bibliografia derivada de la matriz verificada | `paper/micai/refs.bib` | `abc2703b11c6360ea679dec13f2d7db9` | 16757 | `2d96ca7` | SELLADO | 45 entradas. Se generan desde la matriz resuelta por API mas un fichero de correcciones verificadas a mano, cada una con su motivo: una de ellas corregia un DOI que resolvia a un dataset distinto del articulo. |
