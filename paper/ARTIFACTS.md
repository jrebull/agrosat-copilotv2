...
| Fase 6: PDF de envio, version anonima | `paper/micai/main.pdf` | `85261661509cbf7f4deea318b890c3d7` | 633726 | sin seguimiento en git (`*.pdf` global) | SELLADO | 12 paginas A4, cero errores, cero overfull, gate de identidad en verde. `make micai-pdf` lo reconstruye byte a byte desde las fuentes versionadas, asi que el sello vale aunque el binario no viaje. |
