...
| Manuscrito nuevo: figura del soporte por clase, espanol (PDF) | `reports/micai2027/figuras/soporte-es.pdf` | `176d5756552cf244f7191f20ecb9335c` | 21323 | sin seguimiento en git (`*.pdf` global) | SELLADO | **El fichero que de verdad entra en el manuscrito**: `\includegraphics` toma el PDF, no el SVG. Ancho de pagina medido 345,827 pt = `\textwidth` de LNCS, factor de escala 1. |
...
| Manuscrito nuevo: figura del soporte por clase, ingles (PDF) | `reports/micai2027/figuras/soporte-en.pdf` | `b3e3527ef0f1cd3f6b85504dc62f2517` | 21051 | sin seguimiento en git (`*.pdf` global) | SELLADO | El mismo, con rotulos en ingles. Mismo contrato fisico y misma reproducibilidad byte a byte. |
