...
| Fase 6: manuscrito MICAI, fuente principal | `paper/micai/main.tex` | `89a2ccebd91ebfb4fed377007bf59e03` | 4445 | `2d96ca7` | SELLADO | Clase llncs con `\newif\ifanon`; anonimo por defecto, A4 real, `hidelinks`. |
...
| Fase 6: manuscrito en espanol, fuente | `paper/micai/main_es.tex` | `87b7c6dff3dd34b7272c61da0d841b3d` | 4589 | `a35e96f` | SELLADO | Version de lectura y revision del equipo; la de envio es main.tex. |
...
| Fase 8: camera-ready en ingles | `paper/micai/main_cr.pdf` | `8dc92ddbc5af59853f061e0c07ea4e10` | 648427 | sin seguimiento en git (`*.pdf` global) | SELLADO | Firmas con ORCID, afiliacion, agradecimientos y Disclosure of Interests. Sale del MISMO main.tex; el cuerpo es identico al anonimo. |
| Fase 8: camera-ready en espanol | `paper/micai/main_cr_es.pdf` | `fda18ff07fde468b86d52ba8f7beacf3` | 650742 | sin seguimiento en git (`*.pdf` global) | SELLADO | Version de lectura del equipo, no de envio. Mismo cuerpo que su anonima. |
