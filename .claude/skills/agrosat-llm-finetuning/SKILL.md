...
description: Fine-tune Gemma 4 26B-A4B-MoE and Qwen3-VL-30B-A3B with LoRA rank 16 BF16, and serve Qwen3-30B-A3B-Instruct-2507 GPTQ-Int4 with vLLM on Azure H100 NVL 96GB. Gemma 4 remains FUTURE under ADR-011.
...
- Validar VRAM ANTES de lanzar (Gemma 4: ~82 GB / 96; Qwen3-VL: ~92 GB / 96; Qwen3-30B serving: medir antes de fijar una cifra)
