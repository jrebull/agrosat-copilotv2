...
|---|---|
| «Su estimando alineado no está alineado» | Cierto, y **REPARADO EN EL CÓDIGO** el 4 de septiembre: `macro_over` exige el universo del bloque. Medido: encogía el contraste un 42,1 % y un bloque cambiaba de signo. **Los artefactos siguen sin regenerar** y están marcados OBSOLETO en el ledger |
| «Su intervalo remuestrea la unidad equivocada» | Cierto, y **REPARADO EN EL CÓDIGO**: `paired_interval` exige declarar la unidad, y por debajo de tres bloques no publica ni intervalo ni p. Los artefactos siguen sin regenerar. Y una auditoría externa añade algo peor: partir el mismo territorio más fino no crea réplicas independientes, con Jaccard de 0,4273 medio entre los entrenamientos de los folds, y 0,6000 si se cuenta entrenamiento mas validacion — el 0,60 que publicabamos como «entre entrenamientos» era el segundo |
