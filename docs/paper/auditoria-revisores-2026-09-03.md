...
Faltan dos cosas en el apéndice: que **H1 se refutó**, y que la regla de entrega **cambió** respecto de la preregistrada (que era el oráculo de etiqueta). El cambio es correcto y es justo el que invirtió el resultado, y no está declarado como enmienda.
